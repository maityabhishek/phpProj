...
for ($i = 0; $i < 7; $i++) {
	...
	$employmentstatus = addslashes($_POST['employmentstatus']);
     ...
     mysqli_query($conn,"update employee set emp_name='".$emp_name."',empid='".$empid."',email='".$email."',password='".$password."',designation='".$designation."',
    department='".$department."',joiningdate='".$joiningdate."',address='".$address."',address='".$address."',mobile='".$mobile."'
	,emergency='".$emergency"',employmentstatus='".$employmentstatus"' where id = ".$page_id);
