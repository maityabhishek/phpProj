...
if(isset($_POST['submit']))
{
	...
	$chngdept_id=addslashes($_POST['editdept_id']);
    

	$sqlqry="UPDATE department SET dept_name = '".$name."'  WHERE dept_id =".$chngdept_id.";";
...
$sql = $conn->query("select * from department where dept_id=".$dept_id);
					...
					<div id="addDepartmentForm"  >			
							<form class="form-horizontal" method="post" action="">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="deptname" id="deptname" value="<?php echo $result['dept_name']; ?>">
										<input type="text" hidden class="form-control1" name="editdept_id" id="editdept_id" value="<?php echo $result['dept_id']; ?>">
									</div>
									<div class="col-sm-2">
